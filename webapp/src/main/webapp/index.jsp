...
<link href='https://fonts.googleapis.com/css?family=Roboto:400,300,700&subset=latin,latin-ext,greek-ext,greek' rel='stylesheet' type='text/css'>
      ...
      <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="showSlideMenu">
        ...
        <ul>
          ...
          <!--START: FRAME_MENU-->
            ...
            <li><a href="infopage.asp?page=[link_id]" class="menu" target="[link_target]">[link_name]</a></li>
            <!--END: TOP_LINK_FORMAT--> 
            <!--END: menuitems_view-->
          <!--END: FRAME_MENU-->
        </ul>
        ...
        <div class="rightTopMenu">
          <ul>
            <li><a href="#" id="search" class="menu" onclick="javascript:searchModal();"><img src="assets/templates/[template]/images/lens.png"></a></li>
            <li><a href="view_cart.asp"><img src="assets/templates/[template]/images/cart.png"><div id="noItems">[ITEMSINCART]</div></a></li>
          </ul>
        </div>
    ...
    <aside id="leftBar" class="leftBar">
      <div class="column" id="column1"> 
        ...
        <!--START: FRAME_MANUFACTURER-->
          <div id="modManufacturer" class="module">
              <span class="menu-headers">[frame_manufacturer]</span>
              <ul>
    ...
    <div class="wrapper">
      ...
      <div class="ftr-col col3">
        <div class="social-icons">
          ...
          <!--START: social_link_pinterest--><a href="[social_link_pinterest_ul]" class="pinterest" target="_blank" title="Follow Us on Pinterest"><i class="icon-pinterest-circled"></i></a><!--END: social_link_pinterest-->
...
<div id="searchBox">
  <form method="get" name="searchForm" action="search.asp">
    <input type="text" id="searchlight" name="keyword" value="" class="search-text" placeholder="[frame_search]" />
